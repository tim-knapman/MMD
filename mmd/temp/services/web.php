...
<title>Make Me Digital - Web Development - Digital Agency located in Bendigo and servicing surrounding areas, producing high quality websites</title>
...
<script src="js/modernizr.custom.js"></script>
    ...
    <script type="text/javascript">
        if (screen.width <= 479) {
            document.location = "http://www.makemedigital.com.au/test/services/m.php";
        }
    </script>
</head>
    <body>
        ...
        <div class="services-menu">
            <div class="container">
                <ul class="services">
                    <li class="active"><a href="http://www.makemedigital.com.au/test/services/web.php"><i class="fa fa-code fa-2x"></i>Web Development</a></li>
                    <li><a href="http://www.makemedigital.com.au/test/services/graphicdesign.php"><i class="fa fa-pencil fa-2x"></i>Graphic Design</a></li>
                    <li><a href="http://www.makemedigital.com.au/test/services/socialmedia.php"><i class="fa fa-facebook fa-2x"></i>Social Media</a></li>
                    <li><a href="http://www.makemedigital.com.au/test/services/branding.php"><i class="fa fa-building-o fa-2x"></i>Branding &amp; Identity</a></li>
                </ul>
            </div>
        </div>
        <div class="container">
            <section id="service" class="service-single">
                <div class="row">
                    ...
                    <figure class="col-lg-8 col-sm-6  text-right wow fadeInUp delay-02s">
                        <img src="../img/ipad-phone.jpg" alt="">
                    </figure>
                </div>
            </section>
        </div>
