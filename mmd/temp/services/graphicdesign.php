...
<title>Make Me Digital - Graphic Design - Digital Agency located in Bendigo and servicing surrounding areas, producing high quality websites</title>
...
<script src="js/modernizr.custom.js"></script>
    ...
    <body>
        ...
        <div class="services-menu">
            <div class="container">
                <ul class="services">
                    <li><a href="http://www.makemedigital.com.au/test/services/web.php"><i class="fa fa-code fa-2x"></i>Web Development</a></li>
                    <li class="active"><a href="http://www.makemedigital.com.au/test/services/graphicdesign.php"><i class="fa fa-pencil fa-2x"></i>Graphic Design</a></li>
